...
window.addEventListener("load", function () {
  ...
  a.id = "tg-cta";
  a.href = "https://t.me/nis2instrumente";
  a.target = "_blank";
  a.rel = "noopener";
  a.textContent = "📣 Actualizări NIS2 pe Telegram";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!document.getElementById("aff-disclosure")) {
    ...
    d.id = "aff-disclosure";
    d.textContent = "Informare: acest site conține linkuri de afiliere. Dacă cumpărați prin ele, putem primi un comision, fără costuri suplimentare pentru dumneavoastră.";
